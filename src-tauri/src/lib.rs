...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_token_stats_today_summary,
            commands::get_token_stats_today_hourly,
            commands::get_token_stats_today_by_account,
            commands::get_token_stats_today_by_model,
            commands::get_token_stats_today_model_trend,
            commands::get_token_stats_today_account_trend,
