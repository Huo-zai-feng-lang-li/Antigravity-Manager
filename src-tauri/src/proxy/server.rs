...
impl AxumServer {
    ...
    pub async fn start(
        ...
        let admin_routes = Router::new()
            ...
            .route(
                "/stats/token/today/hourly",
                get(admin_get_token_stats_today_hourly),
            )
            .route(
                "/stats/token/today/summary",
                get(admin_get_token_stats_today_summary),
            )
            .route(
                "/stats/token/today/by-account",
                get(admin_get_token_stats_today_by_account),
            )
            .route(
                "/stats/token/today/by-model",
                get(admin_get_token_stats_today_by_model),
            )
            .route(
                "/stats/token/today/model-trend",
                get(admin_get_token_stats_today_model_trend),
            )
            .route(
                "/stats/token/today/account-trend",
                get(admin_get_token_stats_today_account_trend),
            )
...
async fn admin_get_token_stats_today_hourly(
) -> Result<impl IntoResponse, (StatusCode, Json<ErrorResponse>)> {
...
async fn admin_get_token_stats_today_summary(
) -> Result<impl IntoResponse, (StatusCode, Json<ErrorResponse>)> {
...
async fn admin_get_token_stats_today_by_account(
) -> Result<impl IntoResponse, (StatusCode, Json<ErrorResponse>)> {
...
async fn admin_get_token_stats_today_by_model(
) -> Result<impl IntoResponse, (StatusCode, Json<ErrorResponse>)> {
...
async fn admin_get_token_stats_today_model_trend(
) -> Result<impl IntoResponse, (StatusCode, Json<ErrorResponse>)> {
    let res =
        tokio::task::spawn_blocking(move || token_stats::get_today_model_trend_hourly()).await;
    match res {
        Ok(Ok(stats)) => Ok(Json(stats)),
        Ok(Err(e)) => Err((
            StatusCode::INTERNAL_SERVER_ERROR,
...
async fn admin_get_token_stats_today_account_trend(
) -> Result<impl IntoResponse, (StatusCode, Json<ErrorResponse>)> {
    let res =
        tokio::task::spawn_blocking(move || token_stats::get_today_account_trend_hourly()).await;
    match res {
        Ok(Ok(stats)) => Ok(Json(stats)),
        Ok(Err(e)) => Err((
            StatusCode::INTERNAL_SERVER_ERROR,
